...
import gm.rh.excepcion.RecurasoNoEncontradoEcepxion;
...
public class EmpeladoControlador {
    private static final Logger logger =
            LoggerFactory.getLogger(EmpeladoControlador.class);
    ...
    public ResponseEntity<Empleado>
        ...
        if(empleado == null)
            throw new RecurasoNoEncontradoEcepxion("No se encontro el empleado id: " + id);
    ...
    public ResponseEntity<Empleado> actualizarEmpleado(@PathVariable Integer id,
        ...
        Empleado empleado = empleadoServicio.buscarEmpleadoPorId(id);
        if (empleado == null)
            throw new RecurasoNoEncontradoEcepxion("El id recibido no existe: " + id);
    ...
    public ResponseEntity<Map<String, Boolean>>
        ...
        Empleado empleado = empleadoServicio.buscarEmpleadoPorId(id);
        if(empleado == null)
            throw new RecurasoNoEncontradoEcepxion("El id recibidido no existe: " + id);
